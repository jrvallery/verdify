...
export type Body_crops_create_zone_crop_observation = {
    file?: ((Blob | File) | null);
    notes?: (string | null);
...
export type CropsCreateZoneCropObservationData = {
    formData?: Body_crops_create_zone_crop_observation;
    zoneId: string;
};

export type CropsCreateZoneCropObservationResponse = (ZoneCropObservationPublic);

export type CropsListZoneCropObservationsByIdData = {
    zoneCropId: string;
};

export type CropsListZoneCropObservationsByIdResponse = (Array<ZoneCropObservationPublic>);
...
export type ZonesHasCropData = {
    zoneId: string;
};

export type ZonesHasCropResponse = (boolean);