...
REGISTRY: dict[str, TunableDef] = {
    ...
    "irrig_wall_days_mask": TunableDef(
        ...
        cfg_readback_object_id="cfg___irrig_wall_days_mask",
        push_owner="planner",
        planner_pushable=True,
        tier=2,
        notes="Explicit wall watering day mask, bit0=Sunday through bit6=Saturday. Zero preserves legacy interval scheduling.",
    ),
    "irrig_wall_fert_days_mask": TunableDef(
        ...
        cfg_readback_object_id="cfg___irrig_wall_fert_days_mask",
        push_owner="planner",
        planner_pushable=True,
        tier=2,
    ...
    "irrig_center_days_mask": TunableDef(
        ...
        cfg_readback_object_id="cfg___irrig_center_days_mask",
        push_owner="planner",
        planner_pushable=True,
        tier=2,
        notes="Explicit center watering day mask, bit0=Sunday through bit6=Saturday. Zero preserves legacy interval scheduling.",
    ),
    "irrig_center_fert_days_mask": TunableDef(
        ...
        cfg_readback_object_id="cfg___irrig_center_fert_days_mask",
        push_owner="planner",
        planner_pushable=True,
        tier=2,
    ...
    "activity_start_hour": TunableDef(
        ...
        cfg_readback_object_id="cfg___activity_start_hour",
        push_owner="dispatcher_default",
        planner_pushable=False,
        tier=2,
        notes="Dispatcher-owned mirror of the greenhouse light/activity start hour. Direct-wet gates consume it so lights and wetting share one activity policy.",
    ),
    "activity_start_minute": TunableDef(
        ...
        fw_clamp_lo=0,
        fw_clamp_hi=59,
        esp_object_id="activity_start_minute",
        cfg_readback_object_id="cfg___activity_start_minute",
        push_owner="dispatcher_default",
        planner_pushable=False,
        tier=2,
        notes="Dispatcher-owned mirror of the greenhouse light/activity start minute.",
    ),
    "activity_duration_min": TunableDef(
        ...
        cfg_readback_object_id="cfg___activity_duration__min_",
        push_owner="dispatcher_default",
        planner_pushable=False,
        tier=2,
        notes="Dispatcher-owned mirror of the light runtime. Direct wetting is blocked outside this global biological activity window.",
    ),
    "direct_wet_min_temp_f": TunableDef(
        ...
        cfg_readback_object_id="cfg___direct_wet_min_temp__f_",
        push_owner="planner",
        planner_pushable=True,
        tier=2,
    ...
    "direct_wet_south_start_offset_min": TunableDef(
        ...
        cfg_readback_object_id="cfg___direct_wet_south_start_offset__min_",
        push_owner="planner",
        planner_pushable=True,
        tier=2,
    ...
    "direct_wet_south_drydown_before_off_min": TunableDef(
        ...
        cfg_readback_object_id="cfg___direct_wet_south_drydown_before_off__min_",
        push_owner="planner",
        planner_pushable=True,
        tier=2,
    ...
    "direct_wet_west_start_offset_min": TunableDef(
        ...
        cfg_readback_object_id="cfg___direct_wet_west_start_offset__min_",
        push_owner="planner",
        planner_pushable=True,
        tier=2,
    ...
    "direct_wet_west_drydown_before_off_min": TunableDef(
        ...
        cfg_readback_object_id="cfg___direct_wet_west_drydown_before_off__min_",
        push_owner="planner",
        planner_pushable=True,
        tier=2,
    ...
    "direct_wet_center_start_offset_min": TunableDef(
        ...
        cfg_readback_object_id="cfg___direct_wet_center_start_offset__min_",
        push_owner="planner",
        planner_pushable=True,
        tier=2,
    ...
    "direct_wet_center_drydown_before_off_min": TunableDef(
        ...
        cfg_readback_object_id="cfg___direct_wet_center_drydown_before_off__min_",
        push_owner="planner",
        planner_pushable=True,
        tier=2,
    ...
    "sw_direct_wet_gate_enabled": TunableDef(
        ...
        cfg_readback_object_id="cfg_direct_wet_gate_enabled",
        push_owner="planner",
        planner_pushable=True,
        tier=2,
        notes="Master enable for shared activity/direct-wet gating across misters, drips, and fert paths.",
    ),
    # ─────────────────────────────────────────────────────────────────────
