...
SETPOINT_MAP: dict[str, str] = {
    ...
    "direct_wet_wall_start_offset__min_": "direct_wet_wall_start_offset_min",
    "direct_wet_wall_drydown_before_off__min_": "direct_wet_wall_drydown_before_off_min",
...
CFG_READBACK_MAP: dict[str, str] = {
    ...
    "cfg___direct_wet_wall_start_offset__min_": "direct_wet_wall_start_offset_min",
    "cfg___direct_wet_wall_drydown_before_off__min_": "direct_wet_wall_drydown_before_off_min",
